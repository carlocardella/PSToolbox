...
FunctionsToExport = 'Convert-CertBase64DataToFile', 'Convert-CertificateToBase64String', 
               ...
               'ConvertFrom-PsCustomObjectToHashtable', 'Format-Xml', 
               'Get-EncryptedCredentialFromFile', 'Get-NumberFromString', 
               'Get-RandomString', 'Get-WindowTitle', 'Invoke-SqlQuery', 
